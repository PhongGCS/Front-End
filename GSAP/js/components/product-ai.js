...
export class ProductAI extends Component {
  ...
  init() {
    const { sectionImage, sectionBg, titleTop, titleBottom, contentItem } =
      this.refs;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  globalThis.productAI = new ProductAI(".js-product-ai");
});
